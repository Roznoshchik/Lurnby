...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['suggestion_id'], ['suggestion.id'], name=op.f('fk_user_suggestion_id_suggestion')),
    ...
    sa.Column('email', sa.String(length=120), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_approved__sender_user_id_user')),
    ...
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('archived', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_topic_user_id_user')),
    ...
    sa.ForeignKeyConstraint(['article_id'], ['article.id'], name=op.f('fk_highlight_article_id_article')),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_highlight_user_id_user')),
    ...
    sa.ForeignKeyConstraint(['article_id'], ['article.id'], name=op.f('fk_tags_articles_article_id_article')),
    sa.ForeignKeyConstraint(['tag_id'], ['tag.id'], name=op.f('fk_tags_articles_tag_id_tag'))
    )
    op.create_table('tags_topics',
    sa.Column('tag_id', sa.Integer(), nullable=False),
    sa.Column('topic_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['tag_id'], ['tag.id'], name=op.f('fk_tags_topics_tag_id_tag')),
    sa.ForeignKeyConstraint(['topic_id'], ['topic.id'], name=op.f('fk_tags_topics_topic_id_topic'))
    )
    op.create_table('highlights_topics',
    sa.Column('highlight_id', sa.Integer(), nullable=False),
    sa.Column('topic_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['highlight_id'], ['highlight.id'], name=op.f('fk_highlights_topics_highlight_id_highlight')),
    sa.ForeignKeyConstraint(['topic_id'], ['topic.id'], name=op.f('fk_highlights_topics_topic_id_topic')),
    sa.PrimaryKeyConstraint('highlight_id', 'topic_id', name=op.f('pk_highlights_topics'))
    )
    ...
    sa.Column('tag_id', sa.Integer(), nullable=False),
    sa.Column('highlight_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['highlight_id'], ['highlight.id'], name=op.f('fk_tags_highlights_highlight_id_highlight')),
    sa.ForeignKeyConstraint(['tag_id'], ['tag.id'], name=op.f('fk_tags_highlights_tag_id_tag'))
    )
