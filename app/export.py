...
def get_zip(user, ext):
    ...
    path = os.path.join(basedir, f"users/{user.email}")
    if not os.path.isdir(path):
        os.makedirs(path)

    path_to_zip = os.path.join(basedir, f"users/{user.email}.zip")
...
def article_export(user, articles, ext):
    basedir = os.path.abspath(os.path.dirname(__file__))
    path = os.path.join(basedir, f"users/{user.email}/articles")
...
def topics_export(user, topics, ext):
    basedir = os.path.abspath(os.path.dirname(__file__))
    path = os.path.join(basedir, f"users/{user.email}/topics")
...
def highlights_export(user, highlights, ext):
    basedir = os.path.abspath(os.path.dirname(__file__))
    path = os.path.join(basedir, f"users/{user.email}/highlights")
