...
def accept_terms():
    ...
    if request.method == 'POST':
        ...
        if action == 'accept_terms':
            ...
            flash('Thank you for accepting the terms and continuing to use Lurnby', 'success')                        
            ...
            flash('Please accept our updated terms to continue using Lurnby or delete your account below', 'error')
