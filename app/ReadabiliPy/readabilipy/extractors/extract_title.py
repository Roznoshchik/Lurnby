...
def combine_similar_titles(extracted_strings):
    ...
    for title_pair in permutations(extracted_strings, 2):
        ...
        if title_pair[0] in title_pair[1]:
            extracted_strings[title_pair[0]]['score'] += \
                extracted_strings[title_pair[1]]['score']

            extracted_strings[title_pair[0]]['xpaths'] += \
                extracted_strings[title_pair[1]]['xpaths']
        ...
        # the key
            ...
            if (
                    len([c for c in title_pair[0] if c.isupper()]) >
                    len([c for c in title_pair[1] if c.isupper()])
                    ):
